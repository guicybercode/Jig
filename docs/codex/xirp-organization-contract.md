...
`0005_organization.sql` reserved for S3. Implementation is underway; names are
published only with working handlers and tests.
...
S2 allocated migration 0005. Add two tables,
