...
| X07b | Session archive and workflow: backlog/in_progress/in_review/blocked/done. [Changelog](https://backstage.spotify.com/docs/xirp/changelog) | S3 organization modules/controls, S2 contract review, S1 filtering | Workflow must not mutate lifecycle. Session pin is a user-requested extension. |
